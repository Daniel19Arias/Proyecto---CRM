...
public class deleteProducto extends conexionDB {
    ...
    public void deleteProducto() {
        try {
            ...
            String SQL = String.format("DELETE FROM %s WHERE %s = ?",
                    SchemaDB.TAB_PROD, SchemaDB.COL_PROD_ID);
            preparedStatement = conexion.prepareStatement(SQL);
            id_string = JOptionPane.showInputDialog(null, "Ingrese el id del producto que desea eliminar: ");
