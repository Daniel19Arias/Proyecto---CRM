...
public class deleteFacturas extends conexionDB {
    String id_string;
    int id;
    ...
    public void deleteFacturas(){
        try {
            ...
            String  SQL = String.format("DELETE FROM %s WHERE %s = ?",
                    SchemaDB.TAB_FAC,SchemaDB.COL_FAC_ID);
            preparedStatement = conexion.prepareStatement(SQL);
            id_string = JOptionPane.showInputDialog(null, "Ingrese el id del facturas que desea eliminar: ");
