...
public class deleteLeads extends conexionDB {
    ...
    public void deleteLeads() {
        try {
            ...
            String SQL = String.format("DELETE FROM %s WHERE %s = ?",
                    SchemaDB.TAB_LEADS, SchemaDB.COL_LEADS_ID);
            preparedStatement = conexion.prepareStatement(SQL);
            id_string = JOptionPane.showInputDialog(null, "Ingrese el id del Lead que desea eliminar: ");
