...
public class deletePedido extends conexionDB {
    String id_string;
    int id;
    ...
    public void deletePedido(){
        try {
            ...
            String  SQL = String.format("DELETE FROM %s WHERE %s = ?",
                    SchemaDB.TAB_PED,SchemaDB.COL_PED_ID);
            preparedStatement = conexion.prepareStatement(SQL);
            id_string = JOptionPane.showInputDialog(null, "Ingrese el id del pedido que desea eliminar: ");
