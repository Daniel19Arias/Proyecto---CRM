...
public class insertClientes extends conexionDB {
    ...
    // private: array de opciones fijo de esta clase; no tiene sentido que sea accesible desde fuera
    private String[] condiciones = {"Selecciona una opción", "contado", "30 días", "60 días", "90 días"};
